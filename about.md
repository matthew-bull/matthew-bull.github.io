...
I have worked in an **Agile Scrum development team** on a range of mobile-first PHP and javascript based systems. For example [github.com/unikent/programmes-plant]() and [github.com/unikent/of-course](), although I have contributed to many other (private) repositories on projects ranging from a university news system to a student calendar app.
...
I've written a few **blog posts** covering areas such as user-centred design, lean UX, and discovery/alpha/beta phases. See [blogs.kent.ac.uk/webdev/category/user-centered-services/](http://blogs.kent.ac.uk/webdev/category/user-centered-services/)

The past six months have seen me working in a **part-time UX capacity**, alongside my frontend development role. This has given me the chance to participate in planning a UX strategy, writing blog posts, and start building a UX website.
...
I have more recently instigated a working **pattern library** for a new University of Kent web theme. See [github.com/unikent/user-experience](https://github.com/unikent/user-experience). A new theme had been evolving in a number of directions, and there was a need to consolidate elements of these into a single, coherent library. The idea is that the library will act as a developer resource, while at a higher level helping define how the new theme meets the needs of the overall Kent University brand.

## What can I bring to the role?

This role is advertised as being part of a UX virtual team. I feel that I would be able to bring a **bridge between user-centred design and frontend development skills** such as PHP, CSS3, less and javascript.
...
- Going to the Design Museum ([designmuseum.org](http://designmuseum.org)) from time to time!
